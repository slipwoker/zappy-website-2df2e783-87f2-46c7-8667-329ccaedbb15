            ...
            if (isValid) {
                ...
                if (submitButton) {
                    ...
                    setTimeout(() => {
                        ...
                        successMessage.style.cssText = 'color: #28a745; padding: 1rem; margin-top: 1rem; border: 1px solid #28a745; border-radius: 4px; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2df2e783-87f2-46c7-8667-329ccaedbb15',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2df2e783-87f2-46c7-8667-329ccaedbb15';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2df2e783-87f2-46c7-8667-329ccaedbb15';
